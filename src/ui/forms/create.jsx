...
const CreateMatch = forwardRef((props, ref) => {
    ...
    const onSubmit = async (formData) => {
        ...
        const player = { player_id: responseData.player_id, player_name: formData.creator_name }
    ...
    return (
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                {error && <div className=" bg-error p-[1rem] mb-5 rounded-md text-textError ">
                    Error: {exceptions[error.detail]}
                    ...
                    <div>
                        ...
                        <div className="mt-2">
                            <input
                                ...
                                {...register("creator_name", { required: "Player name is required" })}
                            />
                            {errors.creator_name && <p className="text-sm text-textError" role="alert" >{errors.creator_name.message}</p>}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-2">
                            <input
                                ...
                                autoComplete="off"
                                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                {...register("match_name", { required: "Match name is required" })}
                            />
                            {errors.match_name && <p className="text-sm text-textError" role="alert" >{errors.match_name.message}</p>}
                        </div>
                    </div>
