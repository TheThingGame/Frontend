...
const JoinMatch = forwardRef((props, ref) => {
    ...
    const onSubmit = async (formData) => {
        ...
        console.log("ESTOY ACA, DEBERIA ESTARLO")
        ref.current.close();

        const player = { player_id: responseData.player_id, player_name: formData.player_name }
                ...
                <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    <div>
                        ...
                        <div className="mt-2">
                            ...
                            />
                            {errors.player_name && <p className="text-sm text-textError" role="alert" >{errors.player_name.message}</p>}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-2">
                            ...
                            />
                            {errors.code && <p className="text-sm text-textError" role="alert" >{errors.code.message}</p>}
                        </div>
                    </div>
